...
async function call_update(result) {
  ...
  await strapi.query('hero-article-industry').update({id: result.id}, result)
}
 ...
 module.exports = {
     lifecycles: {
        ...
        afterUpdate(result, params, data) {
            console.log(result)
            if (fs.existsSync('/srv/ssg/build_industry.sh')) {
                const args = []
                console.log('build_industry.sh olemas')
                const child = spawn('/srv/ssg/build_industry.sh', args)
