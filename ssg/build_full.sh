...
nice -10 node ./helpers/fetch_industry_person_from_yaml.js && echo 'fetch_industry_person_from_yaml succeeded' || echo 'fetch_industry_person_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_industry_project_from_yaml'
nice -10 node ./helpers/fetch_industry_project_from_yaml.js && echo 'fetch_industry_project_from_yaml succeeded' || echo 'fetch_industry_project_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_discamp_project_from_yaml'
nice -10 node ./helpers/fetch_discamp_project_from_yaml.js && echo 'fetch_discamp_project_from_yaml succeeded' || echo 'fetch_discamp_project_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"
...
nice -10 node ./helpers/fetch_eventival_persons_from_yaml.js && echo 'fetch_eventival_persons_from_yaml succeeded' || echo 'fetch_eventival_persons_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_course_event_from_yaml'
nice -10 node ./helpers/fetch_course_event_from_yaml.js && echo 'fetch_course_event_from_yaml succeeded' || echo 'fetch_course_event_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"
...
nice -10 node ./helpers/fetch_frontpagecourse_block_from_yaml.js && echo 'fetch_frontpagecourse_block_from_yaml succeeded' || echo 'fetch_frontpagecourse_block_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_article_type_from_yaml'
nice -10 node ./helpers/fetch_article_type_from_yaml.js && echo 'fetch article type from yaml' || echo 'fetch_article_type_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_heroarticle_from_yaml'
nice -10 node ./helpers/fetch_heroarticle_from_yaml.js && echo 'fetch_heroarticle_from_yaml succeeded' || echo 'fetch_heroarticle_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_trioblock_from_yaml'
nice -10 node ./helpers/fetch_trioblock_from_yaml.js    && echo 'fetch_trioblock_from_yaml succeeded' || echo 'fetch_trioblock_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_teams_from_yaml'
nice -10 node ./helpers/fetch_teams_from_yaml.js && echo 'fetch_teams_from_yaml succeeded' || echo 'fetch_teams_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_supporter_page_from_yaml'
nice -10 node ./helpers/fetch_supporter_page_from_yaml.js && echo 'fetch_supporter_page_from_yaml succeeded' || echo 'fetch_supporter_page_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"
...
nice -10 node ./helpers/fetch_labels_from_yaml.js && echo 'fetch_labels_from_yaml succeeded' || echo 'fetch_labels_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_footer_from_yaml'
nice -10 node ./helpers/fetch_footer_from_yaml.js && echo 'fetch_footer_from_yaml succeeded' || echo 'fetch_footer_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_menu_from_yaml'
nice -10 node ./helpers/fetch_menu_from_yaml.js && echo 'fetch_menu_from_yaml succeeded' || echo 'fetch_menu_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_menu2_from_yaml'
nice -10 node ./helpers/fetch_menu2_from_yaml.js && echo 'fetch_menu2_from_yaml succeeded' || echo 'fetch_menu2_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_programmes_from_yaml'
nice -10 node ./helpers/fetch_programmes_from_yaml.js && echo 'fetch_programmes_from_yaml succeeded' || echo 'fetch_programmes_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_cassettes_from_yaml'
nice -10 node ./helpers/fetch_cassettes_from_yaml.js && echo 'fetch_cassettes_from_yaml succeeded' || echo 'fetch_cassettes_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_six_film_block_from_yaml'
nice -10 node ./helpers/fetch_six_film_block_from_yaml.js && echo 'fetch_six_film_block_from_yaml succeeded' || echo 'fetch_six_film_block_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_screenings_from_yaml'
nice -10 node ./helpers/fetch_screenings_from_yaml.js && echo 'fetch_screenings_from_yaml succeeded' || echo 'fetch_screenings_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_shops_from_yaml'
nice -10 node ./helpers/fetch_shops_from_yaml.js && echo 'fetch_shops_from_yaml succeeded' || echo 'fetch_shops_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_person_from_yaml'
nice -10 node ./helpers/fetch_person_from_yaml.js && echo 'fetch_person_from_yaml succeeded' || echo 'fetch_person_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'fetch_locations_from_yaml'
nice -10 node ./helpers/fetch_locations_from_yaml.js    && echo 'fetch_locations_from_yaml succeeded' || echo 'fetch_locations_from_yaml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"

echo 'assets/xml'
nice -10 node ./helpers/xml.js && echo 'assets/xml succeeded' || echo 'assets/xml failed. Exit'; exit 1
echo "Time passed: $SECONDS seconds"
